<template>
    <section>
        ...
        <!--列表-->
        <el-table :data="users" highlight-current-row v-loading="tableLoading" @selection-change="selsChange"
                  style="width: 100%;">
            ...
            <el-table-column label="操作" width="160">
                <template slot-scope="scope">
                    <el-button type="primary" icon="el-icon-edit" @click="handleEdit(scope.$index, scope.row)"
                               :disabled="scope.row.userid=='10000'"></el-button>
                    <el-button type="danger" icon="el-icon-delete" @click="handleDel(scope.$index, scope.row)"
                               :disabled="scope.row.userid=='10000'"></el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-col :span="24" class="toolbar">
            <el-button type="danger" @click="batchRemove" :disabled="this.sels.length===0" :loading="sending"
            ...
            <el-form :model="editForm" label-width="80px" :rules="formRules" ref="editForm">
                ...
                <el-form-item label="角色" prop="roleIds">
                    <el-radio-group v-model="editForm.roleIds">
                        <el-radio v-for="(role,index) in roles" :key="index" :label="role.roleid" border>
                            {{role.rolename}}
                        </el-radio>
                    </el-radio-group>
                </el-form-item>
...
<script>
    ...
    export default {
        computed: {...mapGetters(['sending', 'tableLoading'])},
        data() {
